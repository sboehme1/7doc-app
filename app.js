...
var DAYS = {
  de: [
    ...
    steps:[
      ...
      {t:"Atmen (4/6-Rhythmus)",c:"<strong class='step-key'>Einatmen:</strong> Z\u00e4hle innerlich bis 4. Fokus: K\u00fchle Luft an der Nasenspitze.\n\n<strong class='step-key'>Ausatmen:</strong> Z\u00e4hle innerlich bis 6. Fokus: Warme Luft str\u00f6mt raus \u2013 Schultern fallen.\n\n<strong class='step-key'>Wiederhole</strong> diesen Takt in deinem Tempo so oft wie es sich gut anf\u00fchlt.",tips:["Gedanken auf Reisen?<br>Das ist v\u00f6llig okay.<br>Komm einfach sanft zur\u00fcck zum Z\u00e4hlen.","Rhythmus verloren?<br>Atme einmal tief durch.<br>Fang ganz entspannt wieder bei 4 an."],opt:"<strong>Vagus-Impuls</strong><br>Wenn du besonders viel Unruhe sp\u00fcrst:<br>\u00b7 Atme tief ein<br>\u00b7 Setze einen winzigen schnellen Nach-Einatmer oben drauf<br>\u00b7 Halte kurz<br>\u00b7 Atme dann lang aus<br>Das unterbricht die Stress-Reaktion direkt auf k\u00f6rperlicher Ebene. Das kannst du in jeder Situation einsetzen.",optLabel:"Alltagsimpuls"},
...
function renderDay(d){
  ...
  for(var si=0;si<d.steps.length;si++){
    ...
    if(step.opt){s+='<div class="optional-box"><span class="optional-tag">'+(step.optLabel||t("optional"))+'</span><p>'+step.opt+'</p></div>';}
